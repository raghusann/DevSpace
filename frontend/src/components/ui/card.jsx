...
function CardFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-2xl border-t border-slate-200 bg-slate-50 p-(--card-spacing)",
        className
      )}
      {...props}
    />
